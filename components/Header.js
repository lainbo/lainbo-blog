...
export default function Header ({ navBarTitle, fullWidth }) {
  ...
  return (
    <>
      ...
      <div
        className={`sticky-nav group bg-white/[0.7] dark:bg-[#2a2a2a]/[0.8] m-auto w-full h-6 flex flex-row justify-between items-center mb-2 md:mb-12 py-8 bg-opacity-60 ${
